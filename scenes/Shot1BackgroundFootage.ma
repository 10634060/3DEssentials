...
//Name: Shot1BackgroundFootage.ma
//Last modified: Wed, Feb 19, 2014 09:46:53 AM
//Codeset: 1252
...
file -rdi 1 -ns "Shot1PianoMockUp" -dr 1 -rfn "Shot1PianoMockUpRN" "C:/Users/10634060/Documents/GitHub/3DEssentials/maya/scenes/Shot1PianoMockUp.ma";
...
file -r -ns "Shot1PianoMockUp" -dr 1 -rfn "Shot1PianoMockUpRN" "C:/Users/10634060/Documents/GitHub/3DEssentials/maya/scenes/Shot1PianoMockUp.ma";
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 29.195769931039635 10.948376856062719 32.198448135776374 ;
	setAttr ".r" -type "double3" -14.138352729612752 42.200000000000955 1.073344677329877e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 44.821869662032384;
...
createNode nurbsSurface -n "surfaceShape1" -p "CameraShot1RNfosterParent1";
	...
	setAttr ".cpr" 4;
	setAttr ".cps" 4;
createNode transform -n "imagePlane4" -p "surfaceShape1";
	setAttr ".t" -type "double3" 0 2.2398585186047546 0 ;
	setAttr ".r" -type "double3" 0.12606279295221715 -0.50132638006600749 -0.28829916627362584 ;
createNode imagePlane -n "imagePlaneShape4" -p "imagePlane4";
	setAttr -k off ".v";
	setAttr ".fc" 76;
	setAttr ".imn" -type "string" "E:/GitHub/3DEssentials/maya/sourceimages/Shot1WithPerson_00000.png";
...
createNode nurbsSurface -n "surfaceShape2" -p "CameraShot1RNfosterParent1";
	...
	setAttr ".cpr" 4;
	setAttr ".cps" 4;
createNode transform -n "imagePlane3" -p "surfaceShape2";
createNode imagePlane -n "imagePlaneShape3" -p "imagePlane3";
	...
	setAttr ".w" 10;
	setAttr ".h" 10;
createNode nurbsSurface -n "surfaceShape3" -p "CameraShot1RNfosterParent1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".cpr" 4;
	setAttr ".cps" 4;
createNode transform -n "imagePlane2" -p "surfaceShape3";
createNode nurbsSurface -n "surfaceShape4" -p "CameraShot1RNfosterParent1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".cpr" 4;
	setAttr ".cps" 4;
createNode transform -n "imagePlane1" -p "surfaceShape4";
...
createNode reference -n "CameraShot1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"CameraShot1RN" 0
		"CameraShot1RN" 44
		0 "|CameraShot1RNfosterParent1|surfaceShape4->|imagePlane1" "|CameraShot1:camera1|CameraShot1:cameraShape1" 
		"-s -r "
		0 "|CameraShot1RNfosterParent1|surfaceShape3->|imagePlane2" "|CameraShot1:camera1|CameraShot1:cameraShape1" 
		"-s -r "
		0 "|CameraShot1RNfosterParent1|surfaceShape2->|imagePlane3" "|CameraShot1:camera1|CameraShot1:cameraShape1" 
		"-s -r "
		0 "|CameraShot1RNfosterParent1|surfaceShape1->|imagePlane4" "|CameraShot1:camera1|CameraShot1:cameraShape1" 
		"-s -r "
		...
		2 "|CameraShot1:camera1|CameraShot1:cameraShape1" "centerOfInterest" " 79.310027"
		
		2 "|CameraShot1:camera1|CameraShot1:cameraShape1" "tumblePivot" " -type \"double3\" 0 0 0"
		...
		5 4 "CameraShot1RN" "|CameraShot1:camera1|CameraShot1:cameraShape1.imagePlane" 
		"CameraShot1RN.placeHolderList[2]" ""
		5 4 "CameraShot1RN" "|CameraShot1:camera1|CameraShot1:cameraShape1.imagePlane" 
		"CameraShot1RN.placeHolderList[3]" "";
...
createNode reference -n "PianoMockUpTempUVPaintedRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"PianoMockUpTempUVPaintedRN" 0;
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "sharedReferenceNode";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode reference -n "Shot1PianoMockUpRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		"Shot1PianoMockUpRN"
		"Shot1PianoMockUp:DrumsetMockUpRN" 0
		"Shot1PianoMockUp:CameraShot1RN" 0
		"Shot1PianoMockUpRN" 0
		"Shot1PianoMockUp:PianoMockUpRN" 0;
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "imagePlaneShape3.msg" "CameraShot1RN.phl[2]";
connectAttr "imagePlaneShape4.msg" "CameraShot1RN.phl[3]";
...
connectAttr "sharedReferenceNode.sr" "CameraShot1RN.sr";
connectAttr "sharedReferenceNode.sr" "DrumsetMockUpRN.sr";
connectAttr "sharedReferenceNode.sr" "PianoMockUpTempUVPaintedRN.sr";
connectAttr "sharedReferenceNode.sr" "Shot1PianoMockUpRN.sr";
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of Shot1BackgroundFootage.ma
