...
//Name: PianoMockUp.ma
//Last modified: Thu, Feb 06, 2014 09:36:22 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 51.047356642895693 17.079442723448256 31.159439574020244 ;
	setAttr ".r" -type "double3" -15.938352729447622 58.60000000000106 1.5261496559226902e-015 ;
...
createNode mesh -n "SheetHolderShape" -p "SheetHolder";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
connectAttr "transformGeometry20.og" "SheetHolderShape.i";
...
connectAttr "SheetHolderShape.iog" ":initialShadingGroup.dsm" -na;
